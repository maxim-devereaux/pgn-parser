...
describe('grammar', () => {
    ...
    it('should allow start of game commentary', () => {
        ...
        result.comments_pre[0].text.should.be.eql('start of game');
    });
    ...
    it('should allow single line comments', () => {
        ...
        results.should.have.lengthOf(1);
        results[0].comments_pre.should.have.lengthOf(1);
        results[0].comments_pre[0].text.should.be.eql(' lead comment');
    });
